...
Hi my name is Bailey Arick! I have a bachelor's degree in Computer Science and a background in IT but most recently have discovered a passion in Data Analytics roughly 6 months ago. Over that time period, I have focused my skills on Microsoft Excel, SQL, and Tableau. I have programmed in Python before but not in an analytical approach (hoping to incorporate that soon!). 
